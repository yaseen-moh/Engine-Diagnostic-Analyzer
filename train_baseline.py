...
Usage:
    python train_baseline.py --vehicle-id "honda-civic-2019" --duration 300 --mode live
"""
...
def capture_and_train(
    ...
    Args:
        ...
        mode: "live" (real OBD) or "simulate"
        port: OBD port (optional, 'auto' for detection)
    """
    logger.info(f"{'='*60}")
...
def main():
    ...
    parser.add_argument("--port", default=None, help="OBD serial port (use 'auto' for detection)")
